// Iconos SVG inline (set Lucide, embebidos — sin dependencia de CDN en runtime).
// El stroke de cada path es "currentColor": el color final lo define el CSS
// `color` del elemento contenedor, sin necesidad de filtros aproximados.
// Ver Mi-Cerebro/conocimiento/iconos-svg-lucide.md
var ICONS = {
...
function icon(name, opts) {
    ...
    var cls = "icon" + (opts.class ? " " + opts.class : "");
